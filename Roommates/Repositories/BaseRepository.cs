...
namespace Roommates.Repositories
{
    ...
    public class BaseRepository
    {
        ...
        /// </summary>
        /// /// computed property Connection of type SqlConnection creates temporary connection betn your C# app to SQL Server database to execute ONE command like INSERT OR SELECT. Then closes.
